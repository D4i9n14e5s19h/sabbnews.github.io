		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					<!-- <h1 style="font-size: 28px; font-weight: 700; letter-spacing: -1px; text-align: center; margin-top: 30px; margin-bottom: 5px;">Only <span class="wtpsw-sf-blue">November 2022</span> Deal <span class="wtpsw-sf-blue">40% OFF</span></h1>
					...
					<h2>With <span class="wtpsw-sf-blue">35+ plugins</span>, <span class="wtpsw-sf-blue">2000+ templates</span> & $600 saving in <span class="wtpsw-sf-blue">Essential Plugin Bundle</span></h2>
					<h3><span style="text-decoration:line-through; color: #FF1000;">$299</span> <span class="wtpsw-sf-blue" style="font-size:30px;">$179</span> Unlimited Site License</h3>
					<a href="<?php //echo WTPSW_PLUGIN_UPGRADE; ?>" target="_blank" class="wtpsw-sf-btn wtpsw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
					...
					<a href="<?php echo WTPSW_PLUGIN_UPGRADE; ?>" target="_blank" class="wtpsw-sf-btn wtpsw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
