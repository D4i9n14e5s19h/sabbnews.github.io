...
if( ! defined( 'WTPSW_VERSION' ) ) {
	define( 'WTPSW_VERSION', '1.5.7' ); // Version of plugin
}
...
if(!defined( 'WTPSW_PLUGIN_UPGRADE' ) ) {
	define('WTPSW_PLUGIN_UPGRADE','https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Trending-Popular&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
